    ...
    <div className="relative w-[768px] h-[560px] overflow-hidden text-[color:var(--primary-300)]">
      ...
      <div className="relative w-[768px] h-[560px] z-10 flex flex-col py-20 px-8 font-[yapari] justify-between">
        ...
        <div className="w-full flex justify-center items-center gap-10 text-sm">
          ...
          <button
            className="w-[160px] cursor-pointer border-1 py-1 rounded-lg  hover:text-[color:var(--bg-color)] hover:bg-[color:var(--primary-300)] hover:font-medium z-20 transition-all duration-300"
